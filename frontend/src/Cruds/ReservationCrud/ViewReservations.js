        ...
        <div style={{ marginTop: "150px" }}>
            <div className='card'>
                ...
                <div className='container'>
                    ...
                    <span>{reservation.checkindate ? new Date(reservation.checkindate).toLocaleDateString() : ''}</span>
                    <br />
                    <br />
                    <strong>Check-out Date:</strong>
                    <span>{reservation.checkoutdate ? new Date(reservation.checkoutdate).toLocaleDateString() : ''}</span>
                    <br />
                    <br />
